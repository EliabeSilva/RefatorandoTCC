...
if(isset($_POST['cadastrar'])){
    ...
    $email = mysqli_real_escape_string($conn, $_POST['email']);                   //mysqli_real_escape_string($conn, $_POST['nome']) evitar sql injection
    $senha = md5(mysqli_real_escape_string($conn, $_POST['senha']));
    $barbearia_nome = mysqli_real_escape_string($conn, $_POST['nome_barbearia']);
    $telefone = mysqli_real_escape_string($conn, $_POST['telefone_barbearia']);   
    $cep = mysqli_real_escape_string($conn, $_POST['cep']);
    $cnpj = mysqli_real_escape_string($conn, $_POST['cnpj']);
    $rua = mysqli_real_escape_string($conn, $_POST['rua']);
    $numero_barbearia = mysqli_real_escape_string($conn, $_POST['numero_barbearia']);
    ...
    $insert = "INSERT INTO barbearia (nome_dono, cpf_dono, email_dono, senha_dono, nome_barbearia, telefone, cep, cnpj, rua, numero, bairro, cidade, uf) VALUES ('$nome','$cpf', '$email', '$senha','$barbearia_nome', '$telefone', '$cep', '$cnpj', '$rua', '$numero_barbearia', '$bairro', '$cidade', '$uf) ";
